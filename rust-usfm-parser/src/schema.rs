pub const usj_schema: &str = r#"
{
  ...
  "$defs": {
    "markerObject": {
      ...
      "properties": {
        "type": {
          "description": "The kind/category of node or element this is, corresponding to the USFM marker and USX node",
          "type": "string"
        },
        "marker": {
        ...
        "code": {
          "description": "The 3-letter book code  id element ",
          "pattern": "^[0-9A-Z]{3}$",
          "type": "string"
        },
        "altnumber": {
