...
1. The minimal set of markers
    <div style="float:left; white-space:normal;" width="150px" >
    <pre>
    \id GEN
    \c 1
    \p
    \v 1 verse one
    \v 2 verse two
    </pre></div><div style="float:left; white-space:normal;" width=".33%" ><pre>      
    ...
    </pre></div><div style="float:left; white-space:normal;" width="150px" ><pre>      
       {"headers":[
        {"tag":"id",
            "content":"GEN"}
          ],
...
2. Multiple chapters
    ...
    <div style="float:left; white-space:normal;" width="150px" >     <pre>
    \id GEN
    \c 1
    \p
    \v 1 the first verse
